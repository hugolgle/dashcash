...
function LinkStat(props: any) {
    ...
    return (
        <Link to={props.link} className={`w-full flex flex-col-reverse gap-4 justify-between bg-zinc-100 dark:bg-zinc-900 rounded-2xl hover:bg-opacity-80 hover:scale-95 transition-all px-4 py-2 ring-2 ring-inset ${borderColor}`}>
