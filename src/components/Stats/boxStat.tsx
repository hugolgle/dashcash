function BoxStat(props: any) {
    ...
    return (
        <div className={`w-full flex flex-col-reverse gap-4 justify-between font-thin bg-zinc-100 dark:bg-zinc-900 rounded-2xl hover:bg-opacity-80  transition-all px-4 py-2 ring-2 ring-inset ${borderColor}`} >
