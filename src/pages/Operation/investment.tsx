        ...
        <section className="flex flex-col gap-4 ">
            <div className="w-full h-auto relative">
                {selectedUpdate ? (
                    ...
                    <h2 className="  text-5xl font-thin mb-5">{investment.titre}</h2>
                )}
                ...
                <div className="flex flex-col gap-4 w-3/4">
                    ...
                    <div className="flex flex-row w-full gap-4">
                        ...
                        <div className={`h-40 w-full  bg-zinc-100 dark:bg-zinc-900 flex justify-center items-center rounded-2xl ${selectedUpdate ? 'animate-[pulseEdit_1s_ease-in-out_infinite] p-0' : 'p-8'}`}>
                            {
                                selectedUpdate ? (
                                    <input className="h-full w-full bg-transparent text-center text-4xl  rounded-2xl" value={selectedPlateforme} type="text" name="" onChange={(e) => { handlePlateforme(e); handleInputChange(); }} placeholder="Plateforme" />
                                ) : (
                        ...
                        <div className={`h-40 w-full  bg-zinc-100 dark:bg-zinc-900 flex justify-center items-center rounded-2xl ${selectedUpdate ? 'animate-[pulseEdit_1s_ease-in-out_infinite] p-0' : 'p-8'}`}>
                            {
                                selectedUpdate ? (
                                    <input className="h-full w-full bg-transparent text-center text-4xl  rounded-2xl" value={selectedType} type="text" name="" onChange={(e) => { handleType(e); handleInputChange(); }} placeholder="Type" />
                                ) : (
                        ...
                        <div className="flex flex-col w-full gap-4 justify-center items-center">
                            ...
                            {selectedVendre ? (
                                <div className="flex flex-col gap-4 w-full justify-center items-center">
                                    ...
                                    <input className="rounded px-1" value={selectedMontantVendu} type="number" step="0.5" min="0" name="" onChange={(e) => { handleMontantVendu(e); handleInputChange(); }} />
